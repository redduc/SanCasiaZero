...
namespace sczGame
{
    ...
    export class RenderSystem extends sczEcs.SystemBase
    {
        ...
        {
            var renderComponent: RenderComponent = <RenderComponent>entity.getComponentsByType(RenderComponent._getType())[0];

            var translateComponent: TranslateComponent = <TranslateComponent>entity.getComponentsByType(TranslateComponent._getType())[0];
